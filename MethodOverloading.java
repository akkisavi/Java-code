...
{
	static void getPinPsCity(int n)
	{
	System.out.println("Your Pincode is: 421301");
	}
	
	static void getPinPsCity(int n, int m)
	{
	System.out.println("Your Pincode is: 421301");
	...
	static void getPinPsCity(int n, int m, int o)
	{
	System.out.println("Your Pincode is: 421301");
	System.out.println("Your Ps is: Kalyan Post Office");
	...
	{
		case 1:
		MethodOverloading.getPinPsCity(1);
		break;
		
		case 2:
		MethodOverloading.getPinPsCity(1,2);
		break;
		
		case 3:
		MethodOverloading.getPinPsCity(1,2,3);
		break;
